...
8. Else:
   ...
   b. Or:
      ...
      i. Perform the :ref:`action <syntax-act>` :math:`(\ARD~a.\LLEN~l)` to read the length :math:`l` of the shared :ref:`memory instance <syntax-meminst>` at :ref:`memory address <syntax-memaddr>` :math:`a`.

...
INSTRUCTIONS = [
    ...
    Instruction(r'\MEMORYATOMICNOTIFY~\memarg', r'\hex{FE}~\hex{00}', r'[\I32~\I64] \to [\I64]', r'valid-atomic-notify'),
    Instruction(r'\MEMORYATOMICWAIT\K{32}~\memarg', r'\hex{FE}~\hex{01}', r'[\I32~\I32~\I64] \to [\I32]', r'valid-atomic-wait'),
    Instruction(r'\MEMORYATOMICWAIT\K{64}~\memarg', r'\hex{FE}~\hex{02}', r'[\I32~\I64~\I64] \to [\I32]', r'valid-atomic-wait'),
    ...
    Instruction(r'\I32.\ATOMICRMW.\ATOMICADD~\memarg', r'\hex{FE}~\hex{1E}', r'[\I32~\I32] \to [\I32]', r'valid-atomic-rmw', r'exec-atomic-rmw', r'op-iadd'),
    Instruction(r'\I64.\ATOMICRMW.\ATOMICADD~\memarg', r'\hex{FE}~\hex{1F}', r'[\I32~\I64] \to [\I64]', r'valid-atomic-rmw', r'exec-atomic-rmw', r'op-iadd'),
    Instruction(r'\I32.\ATOMICRMW\K{8}.\ATOMICADD\K{\_u}~\memarg', r'\hex{FE}~\hex{20}', r'[\I32~\I32] \to [\I32]', r'valid-atomic-rmwn', r'exec-atomic-rmwn', r'op-iadd'),
    Instruction(r'\I32.\ATOMICRMW\K{16}.\ATOMICADD\K{\_u}~\memarg', r'\hex{FE}~\hex{21}', r'[\I32~\I32] \to [\I32]', r'valid-atomic-rmwn', r'exec-atomic-rmwn', r'op-iadd'),
    Instruction(r'\I64.\ATOMICRMW\K{8}.\ATOMICADD\K{\_u}~\memarg', r'\hex{FE}~\hex{22}', r'[\I32~\I64] \to [\I64]', r'valid-atomic-rmwn', r'exec-atomic-rmwn', r'op-iadd'),
    Instruction(r'\I64.\ATOMICRMW\K{16}.\ATOMICADD\K{\_u}~\memarg', r'\hex{FE}~\hex{23}', r'[\I32~\I64] \to [\I64]', r'valid-atomic-rmwn', r'exec-atomic-rmwn', r'op-iadd'),
    Instruction(r'\I64.\ATOMICRMW\K{32}.\ATOMICADD\K{\_u}~\memarg', r'\hex{FE}~\hex{24}', r'[\I32~\I64] \to [\I64]', r'valid-atomic-rmwn', r'exec-atomic-rmwn', r'op-iadd'),
    Instruction(r'\I32.\ATOMICRMW.\ATOMICSUB~\memarg', r'\hex{FE}~\hex{25}', r'[\I32~\I32] \to [\I32]', r'valid-atomic-rmw', r'exec-atomic-rmw', r'op-isub'),
    Instruction(r'\I64.\ATOMICRMW.\ATOMICSUB~\memarg', r'\hex{FE}~\hex{26}', r'[\I32~\I64] \to [\I64]', r'valid-atomic-rmw', r'exec-atomic-rmw', r'op-isub'),
    Instruction(r'\I32.\ATOMICRMW\K{8}.\ATOMICSUB\K{\_u}~\memarg', r'\hex{FE}~\hex{27}', r'[\I32~\I32] \to [\I32]', r'valid-atomic-rmwn', r'exec-atomic-rmwn', r'op-isub'),
    Instruction(r'\I32.\ATOMICRMW\K{16}.\ATOMICSUB\K{\_u}~\memarg', r'\hex{FE}~\hex{28}', r'[\I32~\I32] \to [\I32]', r'valid-atomic-rmwn', r'exec-atomic-rmwn', r'op-isub'),
    Instruction(r'\I64.\ATOMICRMW\K{8}.\ATOMICSUB\K{\_u}~\memarg', r'\hex{FE}~\hex{29}', r'[\I32~\I64] \to [\I64]', r'valid-atomic-rmwn', r'exec-atomic-rmwn', r'op-isub'),
    Instruction(r'\I64.\ATOMICRMW\K{16}.\ATOMICSUB\K{\_u}~\memarg', r'\hex{FE}~\hex{2A}', r'[\I32~\I64] \to [\I64]', r'valid-atomic-rmwn', r'exec-atomic-rmwn', r'op-isub'),
    Instruction(r'\I64.\ATOMICRMW\K{32}.\ATOMICSUB\K{\_u}~\memarg', r'\hex{FE}~\hex{2B}', r'[\I32~\I64] \to [\I64]', r'valid-atomic-rmwn', r'exec-atomic-rmwn', r'op-isub'),
    Instruction(r'\I32.\ATOMICRMW.\ATOMICAND~\memarg', r'\hex{FE}~\hex{2C}', r'[\I32~\I32] \to [\I32]', r'valid-atomic-rmw', r'exec-atomic-rmw', r'op-iand'),
    Instruction(r'\I64.\ATOMICRMW.\ATOMICAND~\memarg', r'\hex{FE}~\hex{2D}', r'[\I32~\I64] \to [\I64]', r'valid-atomic-rmw', r'exec-atomic-rmw', r'op-iand'),
    Instruction(r'\I32.\ATOMICRMW\K{8}.\ATOMICAND\K{\_u}~\memarg', r'\hex{FE}~\hex{2E}', r'[\I32~\I32] \to [\I32]', r'valid-atomic-rmwn', r'exec-atomic-rmwn', r'op-iand'),
    Instruction(r'\I32.\ATOMICRMW\K{16}.\ATOMICAND\K{\_u}~\memarg', r'\hex{FE}~\hex{2F}', r'[\I32~\I32] \to [\I32]', r'valid-atomic-rmwn', r'exec-atomic-rmwn', r'op-iand'),
    Instruction(r'\I64.\ATOMICRMW\K{8}.\ATOMICAND\K{\_u}~\memarg', r'\hex{FE}~\hex{30}', r'[\I32~\I64] \to [\I64]', r'valid-atomic-rmwn', r'exec-atomic-rmwn', r'op-iand'),
    Instruction(r'\I64.\ATOMICRMW\K{16}.\ATOMICAND\K{\_u}~\memarg', r'\hex{FE}~\hex{31}', r'[\I32~\I64] \to [\I64]', r'valid-atomic-rmwn', r'exec-atomic-rmwn', r'op-iand'),
    Instruction(r'\I64.\ATOMICRMW\K{32}.\ATOMICAND\K{\_u}~\memarg', r'\hex{FE}~\hex{32}', r'[\I32~\I64] \to [\I64]', r'valid-atomic-rmwn', r'exec-atomic-rmwn', r'op-iand'),
    Instruction(r'\I32.\ATOMICRMW.\ATOMICOR~\memarg', r'\hex{FE}~\hex{33}', r'[\I32~\I32] \to [\I32]', r'valid-atomic-rmw', r'exec-atomic-rmw', r'op-ior'),
    Instruction(r'\I64.\ATOMICRMW.\ATOMICOR~\memarg', r'\hex{FE}~\hex{34}', r'[\I32~\I64] \to [\I64]', r'valid-atomic-rmw', r'exec-atomic-rmw', r'op-ior'),
    Instruction(r'\I32.\ATOMICRMW\K{8}.\ATOMICOR\K{\_u}~\memarg', r'\hex{FE}~\hex{35}', r'[\I32~\I32] \to [\I32]', r'valid-atomic-rmwn', r'exec-atomic-rmwn', r'op-ior'),
    Instruction(r'\I32.\ATOMICRMW\K{16}.\ATOMICOR\K{\_u}~\memarg', r'\hex{FE}~\hex{36}', r'[\I32~\I32] \to [\I32]', r'valid-atomic-rmwn', r'exec-atomic-rmwn', r'op-ior'),
    Instruction(r'\I64.\ATOMICRMW\K{8}.\ATOMICOR\K{\_u}~\memarg', r'\hex{FE}~\hex{37}', r'[\I32~\I64] \to [\I64]', r'valid-atomic-rmwn', r'exec-atomic-rmwn', r'op-ior'),
    Instruction(r'\I64.\ATOMICRMW\K{16}.\ATOMICOR\K{\_u}~\memarg', r'\hex{FE}~\hex{38}', r'[\I32~\I64] \to [\I64]', r'valid-atomic-rmwn', r'exec-atomic-rmwn', r'op-ior'),
    Instruction(r'\I64.\ATOMICRMW\K{32}.\ATOMICOR\K{\_u}~\memarg', r'\hex{FE}~\hex{39}', r'[\I32~\I64] \to [\I64]', r'valid-atomic-rmwn', r'exec-atomic-rmwn', r'op-ior'),
    Instruction(r'\I32.\ATOMICRMW.\ATOMICXOR~\memarg', r'\hex{FE}~\hex{3A}', r'[\I32~\I32] \to [\I32]', r'valid-atomic-rmw', r'exec-atomic-rmw', r'op-ixor'),
    Instruction(r'\I64.\ATOMICRMW.\ATOMICXOR~\memarg', r'\hex{FE}~\hex{3B}', r'[\I32~\I64] \to [\I64]', r'valid-atomic-rmw', r'exec-atomic-rmw', r'op-ixor'),
    Instruction(r'\I32.\ATOMICRMW\K{8}.\ATOMICXOR\K{\_u}~\memarg', r'\hex{FE}~\hex{3C}', r'[\I32~\I32] \to [\I32]', r'valid-atomic-rmwn', r'exec-atomic-rmwn', r'op-ixor'),
    Instruction(r'\I32.\ATOMICRMW\K{16}.\ATOMICXOR\K{\_u}~\memarg', r'\hex{FE}~\hex{3D}', r'[\I32~\I32] \to [\I32]', r'valid-atomic-rmwn', r'exec-atomic-rmwn', r'op-ixor'),
    Instruction(r'\I64.\ATOMICRMW\K{8}.\ATOMICXOR\K{\_u}~\memarg', r'\hex{FE}~\hex{3E}', r'[\I32~\I64] \to [\I64]', r'valid-atomic-rmwn', r'exec-atomic-rmwn', r'op-ixor'),
    Instruction(r'\I64.\ATOMICRMW\K{16}.\ATOMICXOR\K{\_u}~\memarg', r'\hex{FE}~\hex{3F}', r'[\I32~\I64] \to [\I64]', r'valid-atomic-rmwn', r'exec-atomic-rmwn', r'op-ixor'),
    Instruction(r'\I64.\ATOMICRMW\K{32}.\ATOMICXOR\K{\_u}~\memarg', r'\hex{FE}~\hex{40}', r'[\I32~\I64] \to [\I64]', r'valid-atomic-rmwn', r'exec-atomic-rmwn', r'op-ixor'),
    Instruction(r'\I32.\ATOMICRMW.\ATOMICXCHG~\memarg', r'\hex{FE}~\hex{41}', r'[\I32~\I32] \to [\I32]', r'valid-atomic-rmw', r'exec-atomic-rmw', r'op-ixchg'),
    Instruction(r'\I64.\ATOMICRMW.\ATOMICXCHG~\memarg', r'\hex{FE}~\hex{42}', r'[\I32~\I64] \to [\I64]', r'valid-atomic-rmw', r'exec-atomic-rmw', r'op-ixchg'),
    Instruction(r'\I32.\ATOMICRMW\K{8}.\ATOMICXCHG\K{\_u}~\memarg', r'\hex{FE}~\hex{43}', r'[\I32~\I32] \to [\I32]', r'valid-atomic-rmwn', r'exec-atomic-rmwn', r'op-ixchg'),
    Instruction(r'\I32.\ATOMICRMW\K{16}.\ATOMICXCHG\K{\_u}~\memarg', r'\hex{FE}~\hex{44}', r'[\I32~\I32] \to [\I32]', r'valid-atomic-rmwn', r'exec-atomic-rmwn', r'op-ixchg'),
    Instruction(r'\I64.\ATOMICRMW\K{8}.\ATOMICXCHG\K{\_u}~\memarg', r'\hex{FE}~\hex{45}', r'[\I32~\I64] \to [\I64]', r'valid-atomic-rmwn', r'exec-atomic-rmwn', r'op-ixchg'),
    Instruction(r'\I64.\ATOMICRMW\K{16}.\ATOMICXCHG\K{\_u}~\memarg', r'\hex{FE}~\hex{46}', r'[\I32~\I64] \to [\I64]', r'valid-atomic-rmwn', r'exec-atomic-rmwn', r'op-ixchg'),
    Instruction(r'\I64.\ATOMICRMW\K{32}.\ATOMICXCHG\K{\_u}~\memarg', r'\hex{FE}~\hex{47}', r'[\I32~\I64] \to [\I64]', r'valid-atomic-rmwn', r'exec-atomic-rmwn', r'op-ixchg'),
    Instruction(r'\I32.\ATOMICRMW.\ATOMICCMPXCHG~\memarg', r'\hex{FE}~\hex{48}', r'[\I32~\I32~\I32] \to [\I32]', r'valid-atomic-rmw-cmpxchg', r'exec-atomic-rmw-cmpxchg'),
    Instruction(r'\I64.\ATOMICRMW.\ATOMICCMPXCHG~\memarg', r'\hex{FE}~\hex{49}', r'[\I32~\I64~\I64] \to [\I64]', r'valid-atomic-rmw-cmpxchg', r'exec-atomic-rmw-cmpxchg'),
    Instruction(r'\I32.\ATOMICRMW\K{8}.\ATOMICCMPXCHG\K{\_u}~\memarg', r'\hex{FE}~\hex{4A}', r'[\I32~\I32~\I32] \to [\I32]', r'valid-atomic-rmwn-cmpxchg', r'exec-atomic-rmwn-cmpxchg'),
    Instruction(r'\I32.\ATOMICRMW\K{16}.\ATOMICCMPXCHG\K{\_u}~\memarg', r'\hex{FE}~\hex{4B}', r'[\I32~\I32~\I32] \to [\I32]', r'valid-atomic-rmwn-cmpxchg', r'exec-atomic-rmwn-cmpxchg'),
    Instruction(r'\I64.\ATOMICRMW\K{8}.\ATOMICCMPXCHG\K{\_u}~\memarg', r'\hex{FE}~\hex{4C}', r'[\I32~\I64~\I64] \to [\I64]', r'valid-atomic-rmwn-cmpxchg', r'exec-atomic-rmwn-cmpxchg'),
    Instruction(r'\I64.\ATOMICRMW\K{16}.\ATOMICCMPXCHG\K{\_u}~\memarg', r'\hex{FE}~\hex{4D}', r'[\I32~\I64~\I64] \to [\I64]', r'valid-atomic-rmwn-cmpxchg', r'exec-atomic-rmwn-cmpxchg'),
    Instruction(r'\I64.\ATOMICRMW\K{32}.\ATOMICCMPXCHG\K{\_u}~\memarg', r'\hex{FE}~\hex{4E}', r'[\I32~\I64~\I64] \to [\I64]', r'valid-atomic-rmwn-cmpxchg', r'exec-atomic-rmwn-cmpxchg'),
]
